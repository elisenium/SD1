...
public class ListeLRU<E> {
	...
	public E supprimerDernier() {
		...
		E dernier = noeudARetirer.element;

		Noeud noeudAvantDernier = noeudARetirer.precedent;
		noeudAvantDernier.suivant = queue;
		queue.precedent = noeudAvantDernier;

		mapElementNoeud.remove(dernier);

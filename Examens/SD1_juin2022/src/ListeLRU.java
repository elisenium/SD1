...
public class ListeLRU<E> {
	...
	public E supprimerDernier() {
		...
		Noeud noeudASupprimer = queue.precedent;
		noeudASupprimer.precedent.suivant = queue;
		queue.precedent = noeudASupprimer.precedent;

		mapElementNoeud.remove(noeudASupprimer.element);
		return noeudASupprimer.element;
	}
